                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="form-group">
                                    <label>Status</label>
                                    <select class="form-control select2bs4" name="status_create_website">
                                        <option <?=$CMSNT->site('status_create_website') == 1 ? 'selected' : '';?>
                                            value="1">ON
                                        </option>
                                        <option <?=$CMSNT->site('status_create_website') == 0 ? 'selected' : '';?>
                                            value="0">
                                            OFF
                                        </option>
                                    </select>
...
$(document).ready(function() {
    $(".edit-charging-btn").click(function() {
        ...
        $.get("<?=BASE_URL('ajaxs/admin/domain-edit.php?id=');?>" + id, function(data) {
